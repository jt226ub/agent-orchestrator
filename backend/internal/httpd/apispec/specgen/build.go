...
var schemaNames = map[string]string{ //nolint:gosec // Public OpenAPI type names include reset-credit contracts; no credential value is stored here.
	...
	"DomainWorkflowTemplate":          "WorkflowTemplate",
	...
	"ControllersClaudeCodeUsageResponse":               "ClaudeCodeUsageResponse",
	"ControllersClaudeCodeUsageIdentityResponse":       "ClaudeCodeUsageIdentityResponse",
	"ControllersClaudeCodeUsagePromotionResponse":      "ClaudeCodeUsagePromotionResponse",
	"ControllersClaudeCodeUsageWindowResponse":         "ClaudeCodeUsageWindowResponse",
	"ControllersEnsureClaudeCodeUsageRequest":          "EnsureClaudeCodeUsageRequest",
	"ControllersAgyAccountIDParam":                     "AgyAccountIDParam",
	"ControllersAgyAccountLoginIDParam":                "AgyAccountLoginIDParam",
	"ControllersEnsureAgyAccountsRequest":              "EnsureAgyAccountsRequest",
	"ControllersAgyAccountsResponse":                   "AgyAccountsResponse",
	"ControllersAgyDeviceReconciliationResponse":       "AgyDeviceReconciliationResponse",
	"ControllersAgyAccountResponse":                    "AgyAccountResponse",
	"ControllersAgyAuthenticationResponse":             "AgyAuthenticationResponse",
	"ControllersAgyCapabilityObservationResponse":      "AgyCapabilityObservationResponse",
	"ControllersAgyAccountCapabilitiesResponse":        "AgyAccountCapabilitiesResponse",
	"ControllersAgyAccountLoginResponse":               "AgyAccountLoginResponse",
	"ControllersAgyActiveLoginResponse":                "AgyActiveLoginResponse",
	"ControllersAgyAccountSwitchResponse":              "AgyAccountSwitchResponse",
	"ControllersAgyAccountSwitchPhase":                 "AgyAccountSwitchPhase",
	"ControllersStartAgyAccountSwitchRequest":          "StartAgyAccountSwitchRequest",
	"ControllersAgyAccountSwitchIDParam":               "AgyAccountSwitchIDParam",
	"ControllersOpenAgyAccountLoginTerminalResponse":   "OpenAgyAccountLoginTerminalResponse",
	"ControllersAgyAccountLoginTerminalResponse":       "AgyAccountLoginTerminalResponse",
...
func agentOperations() []operation {
	return []operation{
		...
		{
			method: http.MethodGet, path: "/api/v1/agents/claude-code/usage", id: "getClaudeCodeUsage", tag: "agents",
			summary: "Return the cached Claude Code plan usage snapshot",
			resps:   []respUnit{{http.StatusOK, controllers.ClaudeCodeUsageResponse{}}, {http.StatusNotImplemented, envelope.APIError{}}},
		},
		{
			method: http.MethodPost, path: "/api/v1/agents/claude-code/usage/ensure", id: "ensureClaudeCodeUsage", tag: "agents",
			summary: "Read the signed-in Claude Code subscription's limits when the cached snapshot is stale",
			reqBody: controllers.EnsureClaudeCodeUsageRequest{},
			resps:   []respUnit{{http.StatusOK, controllers.ClaudeCodeUsageResponse{}}, {http.StatusBadRequest, envelope.APIError{}}, {http.StatusNotImplemented, envelope.APIError{}}},
		},
		{
		...
		{
			method: http.MethodGet, path: "/api/v1/agents/agy/accounts", id: "getAgyAccounts", tag: "agents",
			summary: "Return cached AO Agy accounts and active-account state",
			resps:   []respUnit{{http.StatusOK, controllers.AgyAccountsResponse{}}, {http.StatusServiceUnavailable, envelope.APIError{}}, {http.StatusNotImplemented, envelope.APIError{}}},
		},
		{
			method: http.MethodPost, path: "/api/v1/agents/agy/accounts/ensure", id: "ensureAgyAccounts", tag: "agents",
			summary: "Discover Antigravity accounts and ensure authentication and capacity",
			reqBody: controllers.EnsureAgyAccountsRequest{},
			resps:   []respUnit{{http.StatusOK, controllers.AgyAccountsResponse{}}, {http.StatusBadRequest, envelope.APIError{}}, {http.StatusServiceUnavailable, envelope.APIError{}}, {http.StatusNotImplemented, envelope.APIError{}}},
		},
		{
			method: http.MethodPost, path: "/api/v1/agents/agy/accounts/{accountId}/login-terminal", id: "openAgyAccountReauthenticationTerminal", tag: "agents",
			summary: "Open native Agy sign-in for one retained account", pathParams: []any{controllers.AgyAccountIDParam{}},
			resps: []respUnit{{http.StatusAccepted, controllers.OpenAgyAccountLoginTerminalResponse{}}, {http.StatusBadRequest, envelope.APIError{}}, {http.StatusNotFound, envelope.APIError{}}, {http.StatusConflict, envelope.APIError{}}, {http.StatusServiceUnavailable, envelope.APIError{}}},
		},
		{
			method: http.MethodPost, path: "/api/v1/agents/agy/accounts/{accountId}/logout", id: "logoutAgyAccount", tag: "agents",
			summary: "Log out one retained Agy account", pathParams: []any{controllers.AgyAccountIDParam{}},
			resps: []respUnit{{http.StatusOK, controllers.AgyAccountsResponse{}}, {http.StatusBadRequest, envelope.APIError{}}, {http.StatusNotFound, envelope.APIError{}}, {http.StatusConflict, envelope.APIError{}}, {http.StatusServiceUnavailable, envelope.APIError{}}},
		},
		{
			method: http.MethodDelete, path: "/api/v1/agents/agy/accounts/{accountId}", id: "deleteAgyAccount", tag: "agents",
			summary: "Delete one inactive signed-out Agy account", pathParams: []any{controllers.AgyAccountIDParam{}},
			resps: []respUnit{{http.StatusOK, controllers.AgyAccountsResponse{}}, {http.StatusBadRequest, envelope.APIError{}}, {http.StatusNotFound, envelope.APIError{}}, {http.StatusConflict, envelope.APIError{}}, {http.StatusServiceUnavailable, envelope.APIError{}}},
		},
		{
			method: http.MethodPost, path: "/api/v1/agents/agy/accounts/login-terminal", id: "openAgyAccountLoginTerminal", tag: "agents",
			summary: "Open an inline native login terminal for a new AO Agy account",
			resps:   []respUnit{{http.StatusAccepted, controllers.OpenAgyAccountLoginTerminalResponse{}}, {http.StatusConflict, envelope.APIError{}}, {http.StatusServiceUnavailable, envelope.APIError{}}, {http.StatusNotImplemented, envelope.APIError{}}},
		},
		{
			method: http.MethodPost, path: "/api/v1/agents/agy/accounts/login-operations/{operationId}/verify", id: "verifyAgyAccountLogin", tag: "agents",
			summary: "Verify one native Agy account login operation", pathParams: []any{controllers.AgyAccountLoginIDParam{}},
			resps: []respUnit{{http.StatusOK, controllers.AgyAccountLoginResponse{}}, {http.StatusNotFound, envelope.APIError{}}, {http.StatusServiceUnavailable, envelope.APIError{}}},
		},
		{
			method: http.MethodPost, path: "/api/v1/agents/agy/accounts/login-operations/{operationId}/cancel", id: "cancelAgyAccountLogin", tag: "agents",
			summary: "Cancel one native Agy account login operation", pathParams: []any{controllers.AgyAccountLoginIDParam{}},
			resps: []respUnit{{http.StatusOK, controllers.AgyAccountLoginResponse{}}, {http.StatusNotFound, envelope.APIError{}}, {http.StatusServiceUnavailable, envelope.APIError{}}},
		},
		{
			method: http.MethodGet, path: "/api/v1/agents/agy/accounts/events", id: "streamAgyAccounts", tag: "agents",
			summary:      "Stream cached and live Agy account state",
			resps:        []respUnit{{http.StatusOK, controllers.AgyAccountsResponse{}}, {http.StatusServiceUnavailable, envelope.APIError{}}, {http.StatusNotImplemented, envelope.APIError{}}},
			contentTypes: map[int]string{http.StatusOK: "text/event-stream"},
		},
		{
			method: http.MethodPost, path: "/api/v1/agents/agy/account-switches", id: "startAgyAccountSwitch", tag: "agents",
			summary: "Start a global AO Agy account switch", reqBody: controllers.StartAgyAccountSwitchRequest{},
			resps: []respUnit{{http.StatusAccepted, controllers.AgyAccountSwitchResponse{}}, {http.StatusBadRequest, envelope.APIError{}}, {http.StatusConflict, envelope.APIError{}}, {http.StatusServiceUnavailable, envelope.APIError{}}},
		},
		{
			method: http.MethodGet, path: "/api/v1/agents/agy/account-switches/{switchId}", id: "getAgyAccountSwitch", tag: "agents",
			summary: "Read one durable Agy account switch", pathParams: []any{controllers.AgyAccountSwitchIDParam{}},
			resps: []respUnit{{http.StatusOK, controllers.AgyAccountSwitchResponse{}}, {http.StatusNotFound, envelope.APIError{}}, {http.StatusServiceUnavailable, envelope.APIError{}}, {http.StatusNotImplemented, envelope.APIError{}}},
		},
		{
...
func projectOperations() []operation {
	return []operation{
		...
		{
			method: http.MethodPost, path: "/api/v1/projects/{id}/config/template", id: "applyProjectTemplate", tag: "projects",
			summary:    "Bind a workflow template's profiles to the project's role slots",
			pathParams: []any{controllers.ProjectIDParam{}},
			reqBody:    projectsvc.ApplyTemplateInput{},
			resps: []respUnit{
				{http.StatusOK, controllers.ProjectResponse{}},
				{http.StatusBadRequest, envelope.APIError{}},
				{http.StatusNotFound, envelope.APIError{}},
