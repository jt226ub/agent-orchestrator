// Package agyops owns admission to operations that use or mutate the
// device-global Agy home.
package agyops
...
func (g *Gate) AcquireShared(ctx context.Context) (func(), error) {
	...
	if g.exclusive {
		g.mu.Unlock()
		return nil, ports.ErrAgyAccountSwitchInProgress
	}
...
func (g *Gate) AcquireExclusive(ctx context.Context) (ports.AgyOperationLease, error) {
	if err := ctx.Err(); err != nil {
		return nil, err
	}
	g.mu.Lock()
...
var _ ports.AgyOperationGate = (*Gate)(nil)
